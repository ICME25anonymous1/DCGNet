...
data = dict(
    ...
    train=dict(
        ...
        classes=('pedestrian', 'people', 'bicycle', 'car', 'van', 'truck',
                 'tricycle', 'awning-tricycle', 'bus', 'motor'),
        ann_file='data/VisDrone/annotations/VisDroneTrain.json',
    ...
    val=dict(
        ...
        classes=('pedestrian', 'people', 'bicycle', 'car', 'van', 'truck',
                 'tricycle', 'awning-tricycle', 'bus', 'motor'),
        ann_file='data/VisDrone/annotations/VisDroneVal.json',
...
work_dir = '../SOD_RFLA/new_work/baseline/visdrone_res/retinanet_visdrone_1x'
gpu_ids = [1]
